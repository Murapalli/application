...
st.set_page_config(
    page_title="SalesAnalysis!!!",
    page_icon=":bar_chart:",
    layout="wide"
)
st.write("# Welcome to Instant Coffee Market Analysis :coffee:")
st.sidebar.success("Select a Analysis Field above.")
  
st.image("marketplayers.jpg")
st.write("""The Instant Coffee Market size is estimated at USD 33.18 billion in 2024, and is expected to reach USD 43.54 billion by 2029, growing at a CAGR of 5.58% during the forecast period (2024-2029).
...
st.title("instant market players")
st.image("instantimage.jpg")